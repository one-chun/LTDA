# LTDA
This repository contains the LTDA implementation and datasets used for evaluating PPI prediction models.
----
## Setup
1. Download the LTDA source code.
...
3. See usage for the LTDA command. Sample command for the provided data:
```
python3 main.py -m bfs -t LTDA -i 27K.txt -i4 27K -o test -e 100 -mainfold Hyperboloid
```
